...
@section('main')
    <div class="w-3/4 mt-10 mx-auto">
        ...
        <div class="flex items-center gap-2 mt-1">
            ...
            <span class="text-gray-900 text-base">{{\Carbon\Carbon::parse($mail['content']['created_at'])->format('Y年m月d日H時m分')}}</span>
        </div>
        <h2 class="text-gray-700 font-bold text-2xl mt-4">本文</h2>
        <p class="mt-1 text-base whitespace-pre-wrap sm:text-xl">{!! $mail['content']['body'] !!}</p>
    </div>
@endsection
